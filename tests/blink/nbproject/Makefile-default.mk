...
FINAL_IMAGE=${DISTDIR}/PICGenios.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=teclado.c teste_b4.c serial.c rtc_r.c pwm.c lcd.c itoa.c i2c.c eeprom_ext.c eeprom.c adc.c display7s.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/teclado.p1 ${OBJECTDIR}/teste_b4.p1 ${OBJECTDIR}/serial.p1 ${OBJECTDIR}/rtc_r.p1 ${OBJECTDIR}/pwm.p1 ${OBJECTDIR}/lcd.p1 ${OBJECTDIR}/itoa.p1 ${OBJECTDIR}/i2c.p1 ${OBJECTDIR}/eeprom_ext.p1 ${OBJECTDIR}/eeprom.p1 ${OBJECTDIR}/adc.p1 ${OBJECTDIR}/display7s.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/teclado.p1.d ${OBJECTDIR}/teste_b4.p1.d ${OBJECTDIR}/serial.p1.d ${OBJECTDIR}/rtc_r.p1.d ${OBJECTDIR}/pwm.p1.d ${OBJECTDIR}/lcd.p1.d ${OBJECTDIR}/itoa.p1.d ${OBJECTDIR}/i2c.p1.d ${OBJECTDIR}/eeprom_ext.p1.d ${OBJECTDIR}/eeprom.p1.d ${OBJECTDIR}/adc.p1.d ${OBJECTDIR}/display7s.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/teclado.p1 ${OBJECTDIR}/teste_b4.p1 ${OBJECTDIR}/serial.p1 ${OBJECTDIR}/rtc_r.p1 ${OBJECTDIR}/pwm.p1 ${OBJECTDIR}/lcd.p1 ${OBJECTDIR}/itoa.p1 ${OBJECTDIR}/i2c.p1 ${OBJECTDIR}/eeprom_ext.p1 ${OBJECTDIR}/eeprom.p1 ${OBJECTDIR}/adc.p1 ${OBJECTDIR}/display7s.p1

# Source Files
SOURCEFILES=teclado.c teste_b4.c serial.c rtc_r.c pwm.c lcd.c itoa.c i2c.c eeprom_ext.c eeprom.c adc.c display7s.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/PICGenios.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/PICGenios.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/PICGenios.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -mdebugger=none  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-9 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c90 -gdwarf-3 -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/PICGenios.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} ${DISTDIR}/PICGenios.X.${IMAGE_TYPE}.hex 
	
else
${DISTDIR}/PICGenios.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/PICGenios.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-9 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c90 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/PICGenios.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
