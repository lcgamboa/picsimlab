...
//dip
  ...
  lcd_cmd(_LCD_CLEAR);
  lcd_cmd(_LCD_FIRST_ROW);
  lcd_out_cp(codetxt_to_ramtxt("Desl. RTC e REL1"));
  lcd_cmd(_LCD_SECOND_ROW);
...
//teste RTC
  lcd_cmd(_LCD_CLEAR);
  lcd_cmd(_LCD_FIRST_ROW);
  lcd_out_cp(codetxt_to_ramtxt("Teste RTC"));
...
//dip
  ...
  lcd_cmd(_LCD_CLEAR);
  lcd_cmd(_LCD_FIRST_ROW);
  lcd_out_cp(codetxt_to_ramtxt("Des. DIS* e LED1"));
  lcd_cmd(_LCD_SECOND_ROW);
  lcd_out_cp(codetxt_to_ramtxt("Press. RB1"));
  while(RB1_bit);
...
//teste Teclado
  ...
  lcd_out_cp(codetxt_to_ramtxt("Teste Teclado"));
...
// testar ? 
  lcd_cmd(_LCD_SECOND_ROW);
  lcd_out_cp(codetxt_to_ramtxt(" (s=RB0 n=RB1) ?"));
