CPWindow1::CPWindow1(void) {
  ...
  draw1.EvMouseButtonPress =
      EVMOUSEBUTTONPRESS & CPWindow1::draw1_EvMouseButtonPress;
  draw1.EvMouseButtonRelease =
      EVMOUSEBUTTONRELEASE & CPWindow1::draw1_EvMouseButtonRelease;
  ...
  menu1_File_Exit.EvMenuActive =
      EVMENUACTIVE & CPWindow1::menu1_File_Exit_EvMenuActive;
  ...
  menu1_Help_Contents.EvMenuActive =
      EVMENUACTIVE & CPWindow1::menu1_Help_Contents_EvMenuActive;
  ...
  menu1_Help_About.EvMenuActive =
      EVMENUACTIVE & CPWindow1::menu1_Help_About_EvMenuActive;
