...
CPWindow1::CPWindow1(void) {
    ...
    menu1_Tools_Esp8266ModemSimulator.EvMenuActive =
        EVMENUACTIVE & CPWindow1::menu1_Tools_Esp8266ModemSimulator_EvMenuActive;
    ...
    menu1_Tools_MPLABXDebuggerPlugin.EvMenuActive =
        EVMENUACTIVE & CPWindow1::menu1_Tools_MPLABXDebuggerPlugin_EvMenuActive;
