/* ########################################################################
   ...
   Copyright (c) : 2020       El-khadraouy Mohammed
   <mohammed.el-khadraouy@ecole.ensicaen.fr> Copyright (c) : 2015-2019  Luis
   Claudio Gambôa Lopes
...
cboard_Curiosity_HPC::cboard_Curiosity_HPC(void) {
  Proc =
      "PIC18F27K40"; // default microcontroller if none defined in preferences
...
void cboard_Curiosity_HPC::WritePreferences(void) {
  ...
  Window1.saveprefs(lxT("Curiosity_HPC_clock"),
...
void cboard_Curiosity_HPC::EvMouseButtonPress(uint button, uint x, uint y,
                                              uint state) {
  int i;
...
void cboard_Curiosity_HPC::EvMouseMove(uint button, uint x, uint y,
                                       uint state) {
  int i;
...
void cboard_Curiosity_HPC::EvMouseButtonRelease(uint button, uint x, uint y,
                                                uint state) {
  int i;
