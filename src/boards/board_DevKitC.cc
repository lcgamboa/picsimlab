...
void cboard_DevKitC::WritePreferences(void) {
    ...
    PICSimLab.SavePrefs("ESP32_DevKitC_PWActivePrj", GetPWActiveProject());
    PICSimLab.SavePrefs("ESP32_DevKitC_PWPrjType", GetPWProjectType());
}
...
void cboard_DevKitC::ReadPreferences(char* name, char* value) {
    ...
    if (!strcmp(name, "ESP32_DevKitC_PWActivePrj")) {
        SetPWActiveProject(value);
    }

    if (!strcmp(name, "ESP32_DevKitC_PWPrjType")) {
