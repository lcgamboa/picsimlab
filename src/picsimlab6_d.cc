...
CPWindow6::CPWindow6(void) {
    ...
    SetVisible(0);
    SetPopupMenu(NULL);
    SetTitle(wxT("PICSimLab Project Wizard"));
    ...
    label2.SetText(wxT("Microcontroller: xxx"));
    label2.SetAlign(1);
    CreateChild(&label2);
    // combo1
    ...
    button2.SetText(wxT("Create and Open"));
    CreateChild(&button2);
    // button3
