...
void
sen_ds1621_rst(sen_ds1621_t *ds1621)
{
...
void
sen_ds1621_init(sen_ds1621_t *ds1621)
{
 dprintf ("ds1621 init\n");
...
void
sen_ds1621_end(sen_ds1621_t *ds1621)
{
 dprintf ("ds1621 end\n");
}

unsigned char
sen_ds1621_I2C_io(sen_ds1621_t *ds1621, unsigned char scl, unsigned char sda)
{
...
void
sen_ds1621_setTemp(sen_ds1621_t *ds1621, float temp)
{
 ds1621->Temp = (temp * 2);
...
void
sen_ds1621_set_addr(sen_ds1621_t *ds1621, unsigned char addr)
{
