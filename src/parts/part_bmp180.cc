...
cpart_bmp180::cpart_bmp180(unsigned x, unsigned y)
...
unsigned short cpart_bmp180::get_in_id(char* name) {
...
unsigned short cpart_bmp180::get_out_id(char* name) {
...
lxString cpart_bmp180::WritePreferences(void) {
    char prefs[256];
...
void cpart_bmp180::ReadPreferences(lxString value_) {
...
void cpart_bmp180::EvMouseButtonRelease(uint button, uint x, uint y, uint state) {
    int i;
...
void cpart_bmp180::EvMouseMove(uint button, uint x, uint y, uint state) {
    int i;
