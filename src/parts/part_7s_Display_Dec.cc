...
void
cpart_7s_display_dec::Draw(void)
{
...
unsigned short
cpart_7s_display_dec::get_in_id(char * name)
{
...
cpart_7s_display_dec::get_out_id(char * name)
{
 ...
 if (strcmp (name, "PN_A") == 0)return O_A;
 if (strcmp (name, "PN_B") == 0)return O_B;
 if (strcmp (name, "PN_C") == 0)return O_C;
 if (strcmp (name, "PN_D") == 0)return O_D;

 if (strcmp (name, "PN_D1") == 0)return O_DISP1;
 if (strcmp (name, "PN_D2") == 0)return O_DISP2;
 if (strcmp (name, "PN_D3") == 0)return O_DISP3;
 if (strcmp (name, "PN_D4") == 0)return O_DISP4;

 if (strcmp (name, "PN_FX1") == 0)return O_FX1;
 if (strcmp (name, "PN_FX2") == 0)return O_FX2;
...
void
cpart_7s_display_dec::ConfigurePropertiesWindow(CPWindow * WProp)
{
...
void
cpart_7s_display_dec::ReadPropertiesWindow(CPWindow * WProp)
{
...
void
cpart_7s_display_dec::PreProcess(void)
{
...
void
cpart_7s_display_dec::Process(void)
{
 int i;
 unsigned char value;
 ...
 if (mcount > JUMPSTEPS_)
  {
   ...
   value = 0;
   if (input_pins[0] && ppins[input_pins[0] - 1].value) value |= 0x01;
...
void
cpart_7s_display_dec::PostProcess(void)
{
