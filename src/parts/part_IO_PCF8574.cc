...
cpart_IO_PCF8574::ConfigurePropertiesWindow(CPWindow * wprop)
{
 ...
 if (input_pins[0] == 0)
 ...
 else
  {
   ...
   ((CCombo*) WProp_IO_PCF8574->GetChildByName ("combo1"))->SetText (itoa (input_pins[0]) + "  " + spin);
  }

 ((CCombo*) WProp_IO_PCF8574->GetChildByName ("combo2"))->SetItems (Items);
 if (input_pins[1] == 0)
  ((CCombo*) WProp_IO_PCF8574->GetChildByName ("combo2"))->SetText ("0  NC");
 else
  {
   spin = Window5.GetPinName (input_pins[1]);
   ((CCombo*) WProp_IO_PCF8574->GetChildByName ("combo2"))->SetText (itoa (input_pins[1]) + "  " + spin);
  }

 ((CCombo*) WProp_IO_PCF8574->GetChildByName ("combo3"))->SetItems (Items);
 if (input_pins[2] == 0)
  ((CCombo*) WProp_IO_PCF8574->GetChildByName ("combo3"))->SetText ("0  NC");
 else
  {
   spin = Window5.GetPinName (input_pins[2]);
   ((CCombo*) WProp_IO_PCF8574->GetChildByName ("combo3"))->SetText (itoa (input_pins[2]) + "  " + spin);
  }


 ((CCombo*) WProp_IO_PCF8574->GetChildByName ("combo4"))->SetItems (Items);
 if (input_pins[3] == 0)
  ((CCombo*) WProp_IO_PCF8574->GetChildByName ("combo4"))->SetText ("0  NC");
 else
  {
   spin = Window5.GetPinName (input_pins[3]);
   ((CCombo*) WProp_IO_PCF8574->GetChildByName ("combo4"))->SetText (itoa (input_pins[3]) + "  " + spin);
  }

 ((CCombo*) WProp_IO_PCF8574->GetChildByName ("combo5"))->SetItems (Items);
 if (input_pins[4] == 0)
  ((CCombo*) WProp_IO_PCF8574->GetChildByName ("combo5"))->SetText ("0  NC");
 else
  {
   spin = Window5.GetPinName (input_pins[4]);
   ((CCombo*) WProp_IO_PCF8574->GetChildByName ("combo5"))->SetText (itoa (input_pins[4]) + "  " + spin);
  }



 ((CButton*) WProp_IO_PCF8574->GetChildByName ("button1"))->EvMouseButtonRelease = EVMOUSEBUTTONRELEASE & CPWindow5::PropButtonRelease;
 ((CButton*) WProp_IO_PCF8574->GetChildByName ("button1"))->SetTag (1);

 ((CButton*) WProp_IO_PCF8574->GetChildByName ("button2"))->EvMouseButtonRelease = EVMOUSEBUTTONRELEASE & CPWindow5::PropButtonRelease;
}

void
cpart_IO_PCF8574::ReadPropertiesWindow(void)
{
 input_pins[0] = atoi (((CCombo*) WProp_IO_PCF8574->GetChildByName ("combo1"))->GetText ());
