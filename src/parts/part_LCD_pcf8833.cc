...
unsigned short cpart_LCD_pcf8833::get_in_id(char* name) {
    printf("Erro input '%s' don't have a valid id! \n", name);
    return -1;
};

unsigned short cpart_LCD_pcf8833::get_out_id(char* name) {
...
void cpart_LCD_pcf8833::ReadPreferences(lxString value) {
