...
void cpart_VCD_Dump_an::Draw(void) {
    int i;
    int to;
    int r, g, b;
...
unsigned short cpart_VCD_Dump_an::get_in_id(char* name) {
...
unsigned short cpart_VCD_Dump_an::get_out_id(char* name) {
...
void cpart_VCD_Dump_an::ReadPropertiesWindow(CPWindow* WProp) {
...
void cpart_VCD_Dump_an::EvMouseButtonPress(uint button, uint x, uint y, uint state) {
    int i;
