...
static PCWProp pcwprop[3] = {{PCW_LABEL, "1 - VCC,+5V"}, {PCW_COMBO, "2 - OUT"}, {PCW_LABEL, "2 - GND ,GND"}};

cpart_fm50::cpart_fm50(const unsigned x, const unsigned y, const char* name, const char* type)
    : part(x, y, name, type),
