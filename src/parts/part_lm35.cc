...
void cpart_lm35::EvMouseButtonPress(uint button, uint x, uint y, uint state) {
    int i;
...
void cpart_lm35::EvMouseButtonRelease(uint button, uint x, uint y, uint state) {
    int i;
...
void cpart_lm35::EvMouseMove(uint button, uint x, uint y, uint state) {
    int i;
...
unsigned short cpart_lm35::get_in_id(char* name) {
...
unsigned short cpart_lm35::get_out_id(char* name) {
