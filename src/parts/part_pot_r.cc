...
{
 Window5.SetAPin (input_pins[0], 5.0 * (values[0]) / 200.0);
 Window5.SetAPin (input_pins[1], 5.0 * (values[1]) / 200.0);
 Window5.SetAPin (input_pins[2], 5.0 * (values[2]) / 200.0);
 Window5.SetAPin (input_pins[3], 5.0 * (values[3]) / 200.0);
}
...
part_init("Potentiometers (Rotary)", cpart_pot_r);
