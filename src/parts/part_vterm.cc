...
void
cpart_vterm::ButtonEvent(CControl * control, uint button, uint x, uint y, uint state)
{
...
void
cpart_vterm::Event(CControl * control)
{
...
lxString
cpart_vterm::WritePreferences(void)
{
 char prefs[256];
...
void
cpart_vterm::ReadPreferences(lxString value)
{
...
void
cpart_vterm::ConfigurePropertiesWindow(CPWindow * WProp)
{
...
void
cpart_vterm::ReadPropertiesWindow(CPWindow * WProp)
{
...
{
 vterm_set_clk (&vt, Window1.GetBoard ()->MGetInstClock ());
...
void
cpart_vterm::EvMouseButtonPress(uint button, uint x, uint y, uint state)
{
 int i;
