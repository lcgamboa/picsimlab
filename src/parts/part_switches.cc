...
void cpart_switches::EvMouseButtonPress(uint button, uint x, uint y, uint state) {
    int i;
...
unsigned short cpart_switches::get_in_id(char* name) {
...
unsigned short cpart_switches::get_out_id(char* name) {
