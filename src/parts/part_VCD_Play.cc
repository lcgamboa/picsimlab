...
unsigned short cpart_VCD_Play::get_in_id(char* name) {
...
unsigned short cpart_VCD_Play::get_out_id(char* name) {
...
void cpart_VCD_Play::EvMouseButtonPress(uint button, uint x, uint y, uint state) {
    int i;
