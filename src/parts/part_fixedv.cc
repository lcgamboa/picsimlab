...
void
cpart_fixedv::RegisterRemoteControl(void)
{
...
unsigned short
cpart_fixedv::get_in_id(char * name)
{
...
unsigned short
cpart_fixedv::get_out_id(char * name)
{
 ...
 if (strcmp (name, "DI_VOLT") == 0)return O_VOLT;
...
lxString
cpart_fixedv::WritePreferences(void)
{
 char prefs[256];
...
void
cpart_fixedv::ReadPreferences(lxString value_)
{
 sscanf (value_.c_str (), "%hhu,%hhu", &output_pins[0], &value);
}

void
cpart_fixedv::ConfigurePropertiesWindow(CPWindow * WProp)
{
...
void
cpart_fixedv::ReadPropertiesWindow(CPWindow * WProp)
{
