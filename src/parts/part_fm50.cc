...
void
cpart_fm50::RegisterRemoteControl(void)
{
...
void
cpart_fm50::EvMouseButtonPress(uint button, uint x, uint y, uint state)
{
...
void
cpart_fm50::EvMouseButtonRelease(uint button, uint x, uint y, uint state)
{
 int i;
...
void
cpart_fm50::EvMouseMove(uint button, uint x, uint y, uint state)
{
...
unsigned short
cpart_fm50::get_in_id(char * name)
{
...
unsigned short
cpart_fm50::get_out_id(char * name)
{
...
lxString
cpart_fm50::WritePreferences(void)
{
 char prefs[256];
...
void
cpart_fm50::ReadPreferences(lxString value_)
{
 sscanf (value_.c_str (), "%hhu,%hhu", &output_pins[0], &value);
}

void
cpart_fm50::ConfigurePropertiesWindow(CPWindow * WProp)
{
...
void
cpart_fm50::ReadPropertiesWindow(CPWindow * WProp)
{
