...
void cpart_7s_display_dec::DrawOutput(const unsigned int i) {
    ...
    switch (output[i].id) {
        ...
        case O_FX2:
            ...
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETFGCOLOR, .SetFgColor{155, 155, 155}});
            SpareParts.CanvasCmd(
                {.partn = id, .cmd = CC_ROTATEDTEXT, .RotatedText{"+5V", output[i].x1, output[i].y2, 90.0}});
            break;
        case O_A1:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm1[0], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_B1:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm1[1], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_C1:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm1[2], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_D1:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm1[3], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_E1:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm1[4], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_F1:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm1[5], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_G1:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm1[6], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_P1:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm1[7], 0}});
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_CIRCLE, .Circle{1, output[i].x1, output[i].y1, output[i].r}});
            break;

        case O_A2:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm2[0], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_B2:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm2[1], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_C2:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm2[2], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_D2:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm2[3], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_E2:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm2[4], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_F2:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm2[5], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_G2:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm2[6], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_P2:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm2[7], 0}});
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_CIRCLE, .Circle{1, output[i].x1, output[i].y1, output[i].r}});
            break;

        case O_A3:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm3[0], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_B3:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm3[1], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_C3:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm3[2], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_D3:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm3[3], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_E3:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm3[4], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_F3:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm3[5], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_G3:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm3[6], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_P3:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm3[7], 0}});
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_CIRCLE, .Circle{1, output[i].x1, output[i].y1, output[i].r}});
            break;
            break;
        case O_A4:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm4[0], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_B4:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm4[1], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_C4:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm4[2], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_D4:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm4[3], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_E4:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm4[4], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_F4:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm4[5], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_G4:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm4[6], 0}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
            break;
        case O_P4:
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{0, lm4[7], 0}});
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_CIRCLE, .Circle{1, output[i].x1, output[i].y1, output[i].r}});
            break;
        case O_SS1:
            ...
            SpareParts.CanvasCmd({.partn = id, .cmd = CC_SETCOLOR, .SetColor{10, 10, 10}});
            SpareParts.CanvasCmd(
                {.partn = id,
                 .cmd = CC_RECTANGLE,
                 .Rectangle{1, output[i].x1, output[i].y1, output[i].x2 - output[i].x1, output[i].y2 - output[i].y1}});
...
int cpart_7s_display_dec::ReadPreferences(std::string value) {
