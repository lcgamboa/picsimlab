...
static const char platformio_ini[] =
    ...
    "[env:PICSimLab_Linux]\n"
    "extends = PICSimLab\n"
    "upload_command = /usr/bin/picsimlab_tool load%s \"$BUILD_DIR/firmware.%s\"\n"
    "\n"
    "[env:PICSimLab_Windows]\n"
    "extends = PICSimLab\n"
    "upload_command = C:\\\"Program Files\"\\PicsimLab\\picsimlab_tool.exe load%s \"$BUILD_DIR/firmware.%s\"\n"
    "\n"
    "";
